    	...
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="#" target="_blank">论坛</a></li>
    				    			<li ><a href="jianli/jianli.jsp" rel="nofollow">我的简历</a></li>
	    							    			<li ><a href="jianli/create.jsp" rel="nofollow">发布职位</a></li>
	    		    		</ul>
            	<ul class="loginTop">
					<c:if test="${sessionScope.user != null}">
						<li><a href="javascript:void();" rel="nofollow">欢迎</a></li>
						<li>:</li>
						<li><a href="javascript:void();" rel="nofollow">${sessionScope.user.name }</a></li>
					</c:if>
					<c:if test="${sessionScope.user == null}">
						<li><a href="login.jsp" rel="nofollow">登录</a></li>
						<li>|</li>
						<li><a href="regist.jsp" rel="nofollow">注册</a></li>
					</c:if>
            </ul>
                                </div>
    </div><!-- end #header -->

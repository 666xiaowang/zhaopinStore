...
.BMap_stdMpSliderBgTop {
	...
	width: 10px;
	overflow: hidden;
	background: url(../style/images/img/mapctrls2d0.png) no-repeat -23px
		-226px;
}
...
.BMap_stdMpSliderBgBot {
	...
	top: 124px;
	overflow: hidden;
	background: url(../style/images/img/mapctrls2d0.png) no-repeat -33px
		bottom;
}
...
.sel_body_resitem th div.iconbg {
	background: url(../style/images/img/markers_new_ie6.png) no-repeat
		scroll 0 0;
	height: 29px;
	width: 24px;
}

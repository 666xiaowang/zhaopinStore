...
<script src="../style/js/jquery1.8.3.js" charset="UTF-8"></script>
<script type="text/javascript">
	$(function(){
		$("#rename").click(function(){
			var url = "${pageContext.request.contextPath }/JianLiServlet?method=renameById";
			var params = {"myname":$("#myrename").val(),"userId":"${sessionScope.user.userId}"};
			//不设置回传数据的格式
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="#">论坛</a></li>
        	       ...
        	       <dl class="collapsible_menu">
					<dt>
						<span>${sessionScope.user.name}</span> <span class="red dn" id="noticeDot-0"></span>
						<i></i>
					</dt>
					<dd>
            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		<h1 title="jason的简历"><font color="#019875"><b>${sessionScope.user.name }</b></font>的简历</h1>
            		...
            		<form class="fl dn" id="resumeNameForm">
            			...
            			<input type="text" value="${sessionScope.user.name }" id="myrename" name="name" class="nameEdit c9">	
            			<input type="submit" id="rename" value="保存"> | <a target="_blank" href="h/resume/preview.html">预览</a>
            		</form>
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			    <table>
									<tr>
										...
										<td>工作经验:</td>
										<td>${sessionScope.user.workyear}</td>
									</tr>
									<tr>
										<td>性别:</td>
									...
									<tr>
										<td>学历:</td>
										<td>${sessionScope.user.topDegree}</td>
										<td>电子邮箱:</td>
            		...
            		<div class="basicEdit dn">
            			<form id="profileForm" action="${pageContext.request.contextPath }/JianLiServlet?method=editBasic" method="post">
						  ...
						  <table>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="${sessionScope.user.phoneno}" name="phoneno" id="phoneno">
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
            		...
            		<input type="hidden" id="nameVal" value="${sessionScope.user.name}">
            		<input type="hidden" id="genderVal" value="${sessionScope.user.gender}">
            		<input type="hidden" id="topDegreeVal" value="${sessionScope.user.topDegree}">
            		<input type="hidden" id="workyearVal" value="${sessionScope.user.workyear}">
            		<input type="hidden" id="currentStateVal" value="${sessionScope.user.currentState}">
            		<input type="hidden" id="emailVal" value="${sessionScope.user.email}">
            		<input type="hidden" id="phonenoVal" value="${sessionScope.user.phoneno}">
            	...
            	<div class="profile_box" id="expectJob">
            		...
            		<div class="expectEdit dn">
            			<form id="expectForm" action="${pageContext.request.contextPath }/JianLiServlet?method=expectEdit" method="post">
            			<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>
	            					<td>
	            						<input type="hidden" id="expectCity" value="" name="expectCity" placeholder="期望城市，如：北京">
	            				...
	            				<tr>
	            					...
	            					<td>
	            						<input type="hidden" id="expectSalary" value="${sessionScope.jianli.expectPosition}" name="expectSalary" placeholder="期望月薪">
            		...
            		<input type="hidden" id="expectCityVal" value="${sessionScope.jianli.expectCity}">
            		<input type="hidden" id="typeVal" value="${sessionScope.jianli.type}">
            		<input type="hidden" id="expectPositionVal" value="${sessionScope.jianli.expectPosition}">
            		<input type="hidden" id="expectSalaryVal" value="${sessionScope.jianli.expectSalary}">
            	</div><!--end #expectJob-->
            	...
            	<div class="profile_box" id="workExperience">
            		...
            		<div class="experienceShow dn">
            		        <form class="experienceForm borderBtm dn" action="${pageContext.request.contextPath }/JianLiServlet?method=workExperience" method="post">
	            			<table>
	            				<tbody><tr>
							      	<td valign="top">
							        	<span class="redstar">*</span>
            		...
            		<div class="experienceEdit dn">
            			<form class="experienceForm" action="${pageContext.request.contextPath }/JianLiServlet?method=workExperience" method="post">
            		    	<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>
							      	<td valign="top">
	            				...
	            				<tr>
	            					...
	            					<td>
		            					<div class="fl">
		            						<input type="hidden" class="companyYearStart" value="${sessionScope.jianli.companyYearStart }" name="companyYearStart">
								        	<input type="button" value="开始年份" class="profile_select_139 profile_select_normal select_companyYearStart">
											<div class="box_companyYearStart boxUpDown boxUpDown_139 dn" style="display: none;">
									            <ul>
									        											        			<li>2014</li>
            	...
            	<div class="profile_box" id="projectExperience">
            		...
            		<div class="projectEdit dn">
            			<form class="projectForm" action="${pageContext.request.contextPath }/JianLiServlet?method=projectExperience" method="post">
            				<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>	
	            					<td valign="top">
            	...
            	<div class="profile_box" id="educationalBackground">
            		...
            		<div class="educationalEdit dn">
            			<form class="educationalForm" action="${pageContext.request.contextPath }/JianLiServlet?method=educationalShow" method="post">
            			<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>
							      	<td valign="top">
            	...
            	<div class="profile_box" id="selfDescription">
            		...
            		<div class="descriptionEdit dn">
            			<form class="descriptionFormxx" action="${pageContext.request.contextPath }/JianLiServlet?method=descriptionEdit" method="post">
            			<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>
									<td colspan="2">
            	...
            	<div class="profile_box" id="worksShow">
            		...
            		<div class="workEdit dn">
            			<form class="workForm" action="${pageContext.request.contextPath }/JianLiServlet?method=workShow" method="post">
            			<input type="hidden" value="${sessionScope.user.userId}" name="userId"/>
	            			<table>
	            				<tbody><tr>
							      	<td>
